...
class TestResolveCategoryPairs:
    ...
    def test_ensure_cats_contract_fixes_nat_timestamps(self, sample_cats_data: DataFrame) -> None:
        ...
        required_cols = ['id', 'category_id', 'source', 'level_one', 'level_two', 'level_three', 'updated_at']
    ...
    def test_build_resolution_from_pairs_with_cross_pairs(self, sample_cats_data: DataFrame, sample_pairs_data: DataFrame) -> None:
    ...
    def test_global_category_id_map_no_nat_values(self, sample_cats_data: DataFrame) -> None:
        ...
        # Should have expected columns
        expected_cols = ['global_id', 'category_id', 'source', 'updated_at', 'load_timestamp']
        assert list(result.columns) == expected_cols
